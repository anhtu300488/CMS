                    ...
                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li class="dropdown-content">
                            <ul class="dropdown-menu dropdown-navbar">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="{{ URL::asset('assets/avatars/avatar2.png') }}" class="msg-photo" alt="Kate's Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="{{ URL::asset('assets/avatars/avatar5.png') }}" class="msg-photo" alt="Fred's Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                                            ...
                                            <div class="tab-content padding-8">
                                                ...
                                                <div id="member-tab" class="tab-pane">
                                                    ...
                                                    <div class="clearfix">
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar" src="{{ URL::asset('assets/avatars/user.jpg') }}" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alex Doe's avatar" src="{{ URL::asset('assets/avatars/avatar5.png') }}" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar" src="{{ URL::asset('assets/avatars/avatar2.png') }}" />
                                                            </div>
                                                ...
                                                <div id="comment-tab" class="tab-pane">
                                                    ...
                                                    <div class="comments">
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Jennifer's Avatar" src="{{ URL::asset('assets/avatars/avatar1.png') }}" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Joe's Avatar" src="{{ URL::asset('assets/avatars/avatar2.png') }}" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Rita's Avatar" src="{{ URL::asset('assets/avatars/avatar3.png') }}" />
                                                            </div>
                                        ...
                                        <div class="widget-main no-padding">
                                            ...
                                            <div class="dialogs">
                                                <div class="itemdiv dialogdiv">
                                                    <div class="user">
                                                        <img alt="Alexa's Avatar" src="{{ URL::asset('assets/avatars/avatar1.png') }}" />
                                                    </div>
                                                ...
                                                <div class="itemdiv dialogdiv">
                                                    <div class="user">
                                                        <img alt="Jim's Avatar" src="{{ URL::asset('assets/avatars/avatar4.png') }}" />
                                                    </div>
...
<!--[if !IE]> -->
<script type="text/javascript">
    window.jQuery || document.write("<script src='{{ URL::asset('assets/js/jquery.js') }}'>"+"<"+"/script>");
</script>
...
<!--[if IE]>
<script type="text/javascript">
    window.jQuery || document.write("<script src='{{ URL::asset('assets/js/jquery1x.js') }}'>"+"<"+"/script>");
</script>
<![endif]-->
<script type="text/javascript">
    if('ontouchstart' in document.documentElement) document.write("<script src='{{ URL::asset('assets/js/jquery.mobile.custom.js') }}'>"+"<"+"/script>");
</script>
<script src="{{ URL::asset('assets/js/jquery1x.js') }}"></script>
...
<script src="{{ URL::asset('assets/js/ace/elements.typeahead.js') }}"></script>
...
<script src="{{ URL::asset('assets/js/ace/ace.searchbox-autocomplete.js') }}"></script>
...
<link rel="stylesheet" href="{{ URL::asset('assets/css/ace.onpage-help.css') }}" />
<link rel="stylesheet" href="{{ URL::asset('docs/assets/js/themes/sunburst.css') }}" />

<script type="text/javascript"> ace.vars['base'] = '..'; </script>
<script src="{{ URL::asset('assets/js/ace/elements.onpage-help.js') }}"></script>
<script src="{{ URL::asset('assets/js/ace/ace.onpage-help.js') }}"></script>
<script src="{{ URL::asset('docs/assets/js/rainbow.js') }}"></script>
<script src="{{ URL::asset('docs/assets/js/language/generic.js') }}"></script>
<script src="{{ URL::asset('docs/assets/js/language/html.js') }}"></script>
<script src="{{ URL::asset('docs/assets/js/language/css.js') }}"></script>
<script src="{{ URL::asset('docs/assets/js/language/javascript.js') }}"></script>
</body>
</html>
